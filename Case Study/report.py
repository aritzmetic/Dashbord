...
def create_dash_app_report(flask_app):
    ...
    dash_app_report.layout = html.Div([
        html.H1("📊 Enrollment Dashboard", style={"textAlign": "center", "marginBottom": "20px", "color": "#333", "fontSize": "2.0rem"}),
        ...
        html.Button("Reset Filters", id="reset-button", n_clicks=0, className="reset-button", style={"backgroundColor": "#4CAF50", "color": "white", "padding": "8px 15px", "fontSize": "0.8rem"}),

        html.Hr(style={"marginTop": "15px", "marginBottom": "25px", "borderColor": "#ddd"}),

        # KPI Cards Section
        html.Div(id='kpi-cards', className="kpi-cards-container"),
        ...
        html.H2("⚠️ Watchlist: Flagged Schools", style={"marginTop": "30px", "marginBottom": "12px", "color": "#d32f2f", "fontSize": "1.4rem"}),
        html.Div(id='flagged-schools-table', className="table-container", style={"padding": "15px", "fontSize": "0.8rem"}),

        html.Br(),

        html.Button("⬇ Download Filtered Data", id="btn-download", n_clicks=0, className="download-button", style={"backgroundColor": "#008CBA", "color": "white", "padding": "8px 15px", "fontSize": "0.8rem"}),
